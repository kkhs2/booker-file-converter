const interfaceData = {
  ...
  stdprice: {
    ...
    orders: {
      ...
      od: {
        heading: 'INTCORD-OD-RECTYPE,INTCORD-OD-SUCODE,INTCORD-OD-DESC,INTCORD-OD-ITM-IN-SELL-UNT,INTCORD-OD-PCK-SIZE,INTCORD-OD-QUANTITY,INTCORD-OD-NOTES,INTCORD-OD-PRICE,SUPPLIER-OWN-ITEM-CODE,MARKETPLACE-PRODUCT-CODE,INTCORD-OD-VOUCHER,PRODUCT-SOURCE,PRODUCT-SPECIAL-DISCOUNT',
        regex: /^(.{2})(.{6})(.{28})(.{4})(.{7})(.{5})(.{255})(?<decimal1_2>[^.]{8})(.{15})(.{7})(.{1})(.{1})(?<decimal2_2>[^.]{7})$/d
      },
      oc: [{
    ...
    claims: {
      ch: {
        heading: 'CLAIM-HD-RECTYPE,CLAIM-HD-REFERENCE,CLAIM-HD-CUSTNO,CLAIM-HD-INVOICE-NO,CLAIM-HD-CREATION-DATE,CLAIM-HD-CREATION-TIME,CLAIM-HD-USER-E-MAIL,CLAIM-HD-STATUS,CLAM-HD-WHO-RAISED-CLAIM-IND,CLAIM-HD-WEB-VALIDATED-FLAG',
        regex: /^(.{2})(.{11})(.{9})(.{10})(.{8})(.{6})(.{100})(.{2})(.{1})(.{1})$/d
      },
      cd: {
        heading: 'CLAIM-DL-RECTYPE,CLAIM-DL-LINE-NO,CLAIM-DL-SUCODE,CLAIM-DL-CASE-QTY,CLAIM-DL-UNIT-QTY,CLAIM-DL-REASON-CODE,CLAIM-DL-SUB-REASON-CODE,CLAIM-DL-ADD_INFO,CLAIM-DL-COLLECT-REQ-FLAG,CLAIM-DL-PHOTO-URL,CLAIM-DL-STATUS',
        regex: /^(.{2})(.{4})(.{6})(.{6})(.{6})(.{2})(.{2})(.{150})(.{1})(.{200})(.{2})$/d
      }
    },
    claimstatus: {
