...
import { Carousel as HeroCarousel } from '../../components/Hero/Hero.stories';
import NavBar from '../../components/NavBar/NavBar';
import { LongMenu } from '../../components/NavBar/NavBar.stories';
import MenuCard from '../../components/MenuCard/MenuCard';
import { AwardRail } from '../../components/AwardCard/AwardCard.stories';
import { ExternalImage } from '../../components/PromotionsBanner/PromotionsBanner.stories';
...
import { FeatureCardRail } from '../../components/FeatureCard/FeatureCard.stories';
import { WithBackgroundImage } from '../../components/PromotionsBanner/PromotionsBanner.stories';
import { AllBenefitCards } from '../../components/BenefitCard/BenefitCard.stories';
...
import {
  ...
  QuoteCenter,
  QuoteRight,
} from '../../components/QuoteCard/QuoteCard.stories';
import QuoteCarousel from '../../components/QuoteCard/components/QuoteCarousel';
import QuoteCard from '../../components/QuoteCard/QuoteCard';
import { ProductCardRailSection } from '../../components/ProductCard/ProductCard.stories';
import ContactSection from '../../components/ContactCards/ContactSection';
...
export default {
  // The title under which the ResetPassword component will appear in Storybook's navigation
  ...
  argTypes: {
    open: {
      control: 'boolean',
      description:
        'A boolean value that determines whether the ResetPassword component is open or closed.',
      table: {
  ...
  parameters: {
    ...
    docs: {
      ...
      source: {
        transform: () => {
          return `{/* Reset Password Overlay */}
{/* This component is used to display the reset password overlay */}
{/* You have to add this to the body and trigger it by setting open={true} */}
<ResetPassword open={true} />
      ...
      description: {
        component: `
The Reset Password component is used to display the reset password overlay.

### Usage
Add the ResetPassword component to your page and set the open prop to true to display the overlay. Make sure the component is included only once.

### Design Figma References
- [Reset Password Overlay](https://www.figma.com/design/Ny08zhO5c4Y4FAsXMx7O41/Booker-UI-Design-Library?node-id=2188-6812&m=dev)
        `,
      },
    },
  },
